...
{
    public class CreateOrUpdateAnnouncementValidator : AbstractValidator<CreateOrUpdateAnnoucementRequest>
    {
        ...
        private bool BeValidUserList(List<string> userIds, ValidationContext<CreateOrUpdateAnnoucementRequest> context)
        {
