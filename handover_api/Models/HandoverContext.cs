...
public partial class HandoverContext : DbContext
{
    ...
    public virtual DbSet<HandoverSheetCategorySetting> HandoverSheetCategorySettings { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CategoryItem>(entity =>
        {
            ...
            entity.Property(e => e.ItemType).HasComment("FixedComment,DynamicComment,Selection,SelectionWithTable,Table,RemarkWithVerify");
        });
        ...
        modelBuilder.Entity<HandoverDetailHandler>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity.Property(e => e.Type).HasComment("HANDOVER(交班者),TAKEOVER(接班者)");
        });
        ...
        modelBuilder.Entity<HandoverSheetCategorySetting>(entity =>
        {
